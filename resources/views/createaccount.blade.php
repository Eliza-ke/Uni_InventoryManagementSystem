...
<body>
    <section class="vh-200 bg-image" style="background-color: #DDE6ED">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="/user" method="POST">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="email" id="form3Example3cg" class="form-control form-control-md" name="email" />

                                    </div>
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example4cg">Password</label>
                                        <input type="password" id="form3Example4cg" class="form-control form-control-md" name="password" />
